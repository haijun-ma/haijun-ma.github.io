...
(function (name, factory) {
    ...
    const _w = window, _b = document.body, _d = document.documentElement;
    ...
    Factory.prototype = {
        constructor: Factory, setOptions: function (options) {
            ...
            const ribbon = [], point1 = new Point(startx, starty), point2 = new Point(startx, starty);
            let point3 = null,
            ...
            if (section) {
                ...
                const s = this._options.colorSaturation, l = this._options.colorBrightness,
            ...
            for (let a = 0; a < this._ribbons.length; ++a) {
                const ribbon = this._ribbons[a], numSections = ribbon.length;
                let numDone = 0;
